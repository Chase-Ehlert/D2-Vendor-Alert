    ...
    async sendMessage() {
        ...
        for await (const userRecord of UserSchema.find()) {
            ...
            if (userRecord.bungie_username !== undefined &&
                ...
                user = new User(userRecord.bungie_username, userRecord.discord_id, userRecord.discord_channel_id, userRecord.bungie_membership_id, userRecord.destiny_id, userRecord.destiny_character_id, userRecord.refresh_expiration, userRecord.refresh_token);
